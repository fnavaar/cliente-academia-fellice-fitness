...
| F1-T002 | Registrar canal humano e cobertura por turno | Champion do cliente | SPEC-1-002 | Canal operacional está nomeado e cada turno tem responsável identificado. | `## BLOQUEIOS executáveis` (canal e responsável por turno) | Conferência documental do primeiro bloqueio da SPEC-1-002; nenhuma fila, webhook ou mensagem é criada. | Champion tem a decisão de canal e cobertura. | Pare se houver canal ou turno sem responsável; não apontar WhatsApp, CRM ou outro destino. | bloqueada — aguarda decisão humana | pendente |
