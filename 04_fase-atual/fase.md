...
> A Fase 2 tem duas levas: desbloqueios documentais concluídos em 2026-09-16 e a implementação do autoagendamento/visão operacional em curso — F2-IMP-001..F2-IMP-004 concluídas com aceite humano em 2026-09-17; F2-IMP-005 concluída em 2026-09-17 com veredito ACEITO do Champion — **SPEC-2-001 aceita**; F2-IMP-006 concluída em 2026-09-17 com teste humano aprovado; F2-IMP-007 concluída em 2026-09-18 com teste humano aprovado; F2-IMP-008 concluída em 2026-09-21 com teste humano aprovado; F2-IMP-009 concluída em 2026-09-21 com teste humano aprovado e veredito ACEITO — SPEC-2-002 aceita; implementação da Fase 2 completa (9/9).
...
- [x] Registrar permissões e encaminhamento humano @"Karol e Márcio" #projeto
  > F2-T004 / SPEC-2-002. Critério: matriz de acesso e fila únicas registradas. Evidência: decisões do Champion e da Liderança Comercial registradas em 16/09/2026. Pré-condição: decisões humanas recebidas. Leva 1 documental. Estado final: regras disponíveis para implementação; nenhuma permissão concedida.
...
- [x] Aplicar permissões, fila e assunção de tentativas @"Karol e Márcio" #projeto
  > F2-IMP-007 / SPEC-2-002. Critérios: Consultor limitado; Subgerente/Gestão veem todos; Champion configura; Marketing não vê dados individuais; primeiro Consultor assume; dono, assumed_at e motivo são registrados; não autorizado não altera. Evidência: RBAC pelas regras das coleções (lead_appointments/lead_appointment_events — leitura e escrita só champion/consultor; papel gestao responde 404 e vê 0 itens, sem vazamento) + hook protect_assumption.js (defesa em profundidade em qualquer canal); migrações 0035 (dono/assumed_at/responsavel_anterior + tipo de evento), 0036 (usuário sem permissão + valor gestao no select role), 0037/0039 (tentativas de teste sem dono), 0038 (usuário consultor de teste); debug r1 documentado em 06_notas/debug/ (actor_id vazio — authStore lido no momento do clique); provas ao vivo v0.0.66: assunção via API gravou dono+assumed_at com status preservado (RN-2.08) e evento na trilha; troca de dono recusada 400; remoção de dono recusada 400; update sem tocar dono 200; gestao sem leitura (0 itens) e sem escrita (404). Teste humano do consultor aprovado em 18/09/2026 ("Testei e funcionou") — assunção na /visao com dono e hora exibidos, bloqueio do papel sem permissão confirmado. Revalidação independente no fechamento (v0.0.71): 7 provas refazeitas do zero, todas PASSOU; limpeza pós-aceite (0040 no-op silencioso corrigido pela 0041): usuários sintéticos removidos (login 400), tentativas 007/007b e eventos delas removidos, fixtures 0001..0004 e evento da 0004 preservados. Aprendizado AP-2026-09-18-0940. Pré-condição: F2-IMP-006 aceita. Leva 8. Estado final: RBAC e fila demonstrados em teste. **Concluída.**
- [x] Implementar a escalada visual e o rollback da fila @"Karol e Márcio" #projeto
  > F2-IMP-008 / SPEC-2-002. Critérios: parada até o fim do turno sinaliza; Gestão/Subgerente/Supervisora Mel reatribuem ou encerram com motivo; nenhum estado muda automaticamente; rollback preserva registros. Evidência: implementação Skip v0.0.75 (`6b9f0f1`) com escalada visual, reatribuição formal, encerramento com motivo, papel `supervisora`, rollback/restore e correções r1/r2; pipeline QA completo passou. Teste humano do Ricardo em 21/09/2026: passos 1–3 e 5–7 aprovados; passo 4 aprovado após a correção da rota formal e a exibição de `responsavel_anterior` no card. Revalidação independente: Consultor sem permissão 403; rollback bloqueia ação 400 e restore reativa; reatribuição 200; status preservado em `ENCAMINHAMENTO_HUMANO`; eventos ASSUMED/REASSIGNED/ESCALATED/CLOSED preservados. Migração 0046 aplicada em v0.0.76 (`fca545d`), removeu dados sintéticos da task/debug, usuários temporários e eventos de controle, restaurou a fixture-base 0004 e deixou a fila ativa; logins sintéticos retornam 400; rotas do preview respondem 200. Aprendizados e Debug Summary registrados em `06_notas/`. Pré-condição: F2-IMP-007 aceita. Leva 9. Estado final: escalada, reatribuição, encerramento e rollback demonstrados sem automação indevida. **Concluída.**
- [x] Consolidar o TDD e aceitar a visão operacional @"Karol e Márcio" #projeto
  > F2-IMP-009 / SPEC-2-002. Critérios: CA-2.06..CA-2.10 demonstrados; permissões negativas, reprocessamento, assunção, escalada e rollback evidenciados; Champion aprova ou reprova. Evidência: consolidação v0.0.77 (a3c644b) com migração 0047 (6 fixtures em todos os estados + 4 usuários sintéticos) e 24/24 provas ao vivo via API; pacote de evidências em 06_notas/aceites/pacote-evidencias-spec-2-002.md e roteiro do Champion em 06_notas/aceites/roteiro-teste-champion-spec-2-002.md; debug r1 (dono exibido errado na troca de usuário — myUserId lido do authStore no render, v0.0.78 0bffd92) e r2 (cache do navegador no reteste — hard refresh, sem mudança de código) documentados em 06_notas/debug/; reteste humano aprovado pelo consultor em 21/09/2026 ("Passo 2 ok após o hard refresh"); revalidação independente de fechamento 19/19 (visibilidade por papel, trilha com actor correto, idempotência, bloqueios 403/400, controle da fila, rotas 200); limpeza pós-aceite (0049, v0.0.79 23f7e39) removeu 9 fixtures, 4 usuários sintéticos e eventos de controle — logins sintéticos retornam 400 e rotas do preview 200. Pré-condição: F2-IMP-008 aceita. Leva 10. Estado final: SPEC-2-002 ACEITA (recibo abaixo); Fase 2 ainda não avança sem liberação formal. **Concluída.**

## Recibo de aceite — SPEC-2-002 (2026-09-21)

- **Task:** F2-IMP-009 — Consolidar o TDD e aceitar a visão operacional.
- **Pacote de evidências:** `06_notas/aceites/pacote-evidencias-spec-2-002.md` (CA-2.06..CA-2.10 com provas executadas; dados 100% sintéticos).
- **Roteiro de teste do Champion:** `06_notas/aceites/roteiro-teste-champion-spec-2-002.md` (5 cenários na /visao, 10–15 min).
- **Teste humano:** executado pelo consultor Ricardo Junior em 21/09/2026 — cenários 1, 3 e 4 aprovados na primeira rodada; cenário 2 aprovado após a correção r1 (v0.0.78) e reteste com hard refresh ("Passo 2 ok após o hard refresh"); cenário 5 aprovado com a fixture dedicada e o roteiro ajustado (durante o rollback o botão de assunção some por design — bloqueio server-side provado via API).
- **Veredito do Champion (Karol e Márcio):** ✅ **ACEITO** — 2026-09-21, registrado via consultor Ricardo Junior. **SPEC-2-002 encerrada.**
- **Pendências destacadas para decisão consciente:** LGPD (base legal do agendamento), RN-2.06 (semântica de reagendamento), capacidade 2 no sábado [VALIDAR] e continuidade triagem → agendamento (vínculo hoje apenas estrutural).
- **Ponto de parada:** a Fase 2 encerra a implementação (9/9) e não avança para a Fase 3 sem liberação formal do Champion.
